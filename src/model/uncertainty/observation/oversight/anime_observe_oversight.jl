...
# robot observes objects
# sensor sometimes overlooks objects

module AnimeObserveOversight
  ...
  function main(time_interval=0.1; is_test=false)
    ...
    if is_test == false
      ...
      path = "src/model/uncertainty/observation/oversight/anime_observe_oversight.gif"
