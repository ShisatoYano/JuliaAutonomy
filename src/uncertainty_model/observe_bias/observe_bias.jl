...
# robot observes landmarks with noise and bias
...
module ObserveBias
    ...
    function main()
        ...
        add_landmark(map, Landmark(3.0, 3.0))
        add_landmark(map, Landmark(3.0, -2.0))
        add_landmark(map, Landmark(3.0, 0.0))
        add_landmark(map, Landmark(3.0, 1.0))
        ...
        save_path = joinpath(split(@__FILE__, "src")[1], "gif/observe_bias.gif")
