...
# robot observes landmarks or phantom
# phantom sometimes appears at place there's no landmarks

module ObservePhantom
    ...
    function main()
        ...
        save_path = joinpath(split(@__FILE__, "src")[1], "gif/observe_phantom.gif")
