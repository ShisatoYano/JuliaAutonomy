# module for checking narrow particle movement
# using narrow noise parameters

module AnimeNarrowStd
  ...
  function main(time_interval=0.1; is_test=false)
    ...
    noises = Dict("nn"=>0.001, "no"=>0.002, "on"=>0.003, "oo"=>0.004)
    ...
    if is_test == false
      ...
      path = "src/localization/particle_filter/parameter_adjustment/narrow_std/anime_narrow_std.gif"
