...
module AnimeOcclusionFreeMcl
  ...
  include(joinpath(split(@__FILE__, "src")[1], "src/localization/particle_filter/occlusion_free_mcl/occlusion_free_mcl.jl"))
  ...
  function main(time_interval=0.1; is_test=false)
    ...
    e = OcclusionFreeMcl(init_pose, 100, noises, env_map=m, 
    ...
    if is_test == false
      ...
      path = "src/localization/particle_filter/occlusion_free_mcl/anime_occlusion_free_mcl.gif"
