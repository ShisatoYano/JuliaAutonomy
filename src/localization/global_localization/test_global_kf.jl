# test global localization by kalman filter
...
module TestGlobalKf
  ...
  function single_test(time_interval=0.1, test_time=30)
    ...
    e = GlobalKf(init_pose, env_map=m)
  ...
  function main(test_num=1000)
    ...
    println("Global Kf Accuracy: $(convergence_count)/$(test_num)")
  end
end