...
mutable struct ExpansionResetMcl
  particles
  ...
  # init
  function ExpansionResetMcl(init_pose::Array, num::Int64;
...
function observation_update(self::ExpansionResetMcl, observation)
  for p in self.particles
...
function resampling(self::ExpansionResetMcl)
...
function draw!(self::ExpansionResetMcl)
