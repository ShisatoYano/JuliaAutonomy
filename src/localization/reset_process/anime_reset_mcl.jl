...
module AnimeResetMcl
  ...
  include(joinpath(split(@__FILE__, "src")[1], "src/localization/reset_process/reset_mcl.jl"))
  ...
  function main(time_interval=0.1; is_test=false)
    ...
    if is_test == false
      ...
      path = "src/localization/reset_process/anime_reset_mcl.gif"
