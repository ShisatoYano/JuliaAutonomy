...
module AnimeExpansionSensorResetMcl
  ...
  include(joinpath(split(@__FILE__, "src")[1], "src/localization/reset_process/expansion_sensor_reset_mcl/expansion_sensor_reset_mcl.jl"))
  ...
  function main(time_interval=0.1; is_test=false)
    ...
    e = ExpansionSensorResetMcl(init_pose, 100, env_map=m)
    ...
    if is_test == false
      ...
      path = "src/localization/reset_process/expansion_sensor_reset_mcl/anime_expansion_sensor_reset_mcl.gif"
